...
export default function Navbar() {
  return (
    <div className="h-20 w-full p-5 md:px-16 md:pr-24 bg-bgdarkgray text-bgwhite text-md flex justify-center md:justify-between items-center fixed top-0 z-10 md:opacity-90 drop-shadow-md">
      <div>
