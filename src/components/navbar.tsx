...
export default function Navbar() {
  return (
    <div className="h-20 w-full p-5 md:px-16 md:pr-24 bg-bgdarkgray/30 backdrop-blur-md text-bgwhite text-md flex justify-center md:justify-between items-center fixed top-0 z-10 drop-shadow-md">
      <div>
